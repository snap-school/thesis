...
Cette \gls{mission} vise à ce que les participants puissent prendre en main l'interface de \gls{snap} et à introduire la notion de suite d'instructions. Ils doivent enchaîner des \glspl{bloc} de déplacement dans lesquelles, le nombre de pas ou l'angle de virage sont à compléter. A la base les élèves n'ont rien en dessous des premiers blocs jaunes, La figure \ref{fig:mission-voiture} montre la solution de la mission.
