...
%TODO il manque une vue globale sur les concept informatique présenté: les élément de base pour faire de l'impératif (condition, boucle) et l'intuition de la programmation événementiel (car pas expliqué aux étudiants).
