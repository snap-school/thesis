...
Les missions ont donc été conçues dans le but de pouvoir réaliser ce jeu. L'accent est donc plus porté sur la réalisation d'un jeu amenant les principaux concepts de programmation que sur les concepts en eux-même. %TODO beaucoup plus développer
