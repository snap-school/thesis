...
Cette section traite de l'implémentation de la solution Rsnap ainsi qu'une présentation de son utilisation.
...
\paragraph{\texttt{FileMission}} Les fichiers liés à une mission sont les différentes images qui composent la description. %TODO dans furture work : on peut imaginer rajouter la possibilité de mettre d'autre style de fichier dedans : ex. PDF, slide de cours...
...
\subparagraph{Réaliser un projet libre} Si l'étudiant a envie de créer quelque chose, il va dans le menu "projet libre". Il utilise Snap! à son plein potentiel et laisse libre court à son imagination pour créer le programme de ses rêves.
