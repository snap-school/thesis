...
La quatrième \gls{mission}, "chien et chat", a passionné les élèves, mais ils ont été frustrés par le manque de temps. Personne n'a réussi à la finir. Elle obtient donc une note moyenne de 2.8 mais avec une variance très grande à 1.6. Il faudrait peut-être envisager de guider davantage les étudiants dans cette \gls{mission}. Par exemple, tous les \glspl{bloc} y étaient accessibles, ceci afin que les étudiants puissent découvrir ce qui est possible de faire avec \gls{snap}. L'analyse des commentaires montre que les étudiants se perdent dans la masse de \glspl{bloc} disponibles.
