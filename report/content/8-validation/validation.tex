...
Les enfants avaient l'impression de connaître assez bien l'utilisation d'un ordinateur avant de venir et que notre expérience n'a pas aidé dans l'utilisation. En effet, le score moyen de ces deux métrique est respectivement de 3,3 et 2,4 et une variance de 0,7 et 1,3.

La compréhension de ce qu'est la programmation, c'est par ailleurs bien améliorée. Globalement, ils ne savaient pas ce qu'est la programmation (moyenne de 1,8). Cette donnée est a relativiser car la variance est importante : 1,0. Après l'expérience, les participants comprenaient beaucoup mieux ce qu'est la programmation (moyenne de 3,3 et variance 0,8).
\begin{figure}
  \begin{center}%TODO use subfigure
...
\label{appreciation}
En plus de l'évaluation de leur niveau de compétences en informatique et en programmation, les participants ont également évalué séparément chaque mission. Les graphiques représentant cette évaluation sont sur la figure \ref{fig:evaluation-mission}. On voit que les missions qui ont été le moins appréciées sont la troisième, "soyons courtois", et la quatrième, "chien et chat". Le score des missions est présenté dans le tableau \ref{tab:form}
\begin{figure}
  \begin{center}%TODO use subfigure
...
\begin{table}
  ...
  \begin{center}
    \begin{tabular}{r|llll}
      Mission          & Moyenne & Variance & Moyenne du fondamental & Moyenne du secondaire \\ \hline
      En voiture       & & & & \\
      Hélicoptère      & & & & \\
      Soyons courtois  & & & & \\
      Chien et chat    & & & & \\
...
\paragraph{Appréciation générale}
