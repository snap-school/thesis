...
Pour aller plus loin, il serait intéressant d'avoir un compteur de \glspl{bloc}  pour les \glstpl{script}. En effet, un programme fait avec 20 \glspl{bloc}  quand la solution optimale en compte 3 ne mérite probablement pas autant de point.
