...
Rails permet de résoudre ces besoins de manière adéquate. En effet comme expliqué précédemment (\ref{rails}), rails permet de créer une rapidement une application web.
