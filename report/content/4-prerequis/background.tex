...
Cette application est implémentée en JavaScript. Donc, de bonnes connaissances dans ce langage de programmation seront un atout pour comprendre les logiciels utilisés et les apports et modifications apportées à ceux-ci.
...
Des connaissances sur l'architecture de type \gls{mvc} sont nécessaires.
