...
Il n'est pas directement une plateforme d'éducation dans le sens où il peut être utilisé autant pour l'éducation que pour le business, les jeux, etc. En effet, Blockly est juste une interface graphique en pièces de puzzle sur des fonctions écrites en JavaScript. Celles-ci permettent d'intéragir avec le domaine d'utilisation. Il faut donc que pour chaque domaine, une implémentation des \glspl{bloc} soit réalisée.\\
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=.9\textwidth]{content/5-related_work/images/scratch-printscreen}
