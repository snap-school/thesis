...
\newglossaryentry{rest}
{
 ...
 description={REST est un style d’architecture pour les systèmes hypermédias distribués. Il impose une communication sans état et une interface uniforme.}
}
...
{
 name={secondaire},
 description={L'enseignement secondaire est la seconde partie de l'enseignement officiel obligatoire pour les enfants typiquement de 12 à 18 ans en Belgique.}
}
